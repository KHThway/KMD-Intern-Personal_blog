    ...
    <div class="md:container md:mx-auto rounded-lg mt-5 bg-white p-5">
        <form action="{{ route('posts.update', $post->id) }}" class="row g-3 mx-2" method="POST"
            ...
            <div class="col-sm-12 col-md-6 form-group mt-2 p-2">
                ...
                @if ($post->image1)
                    <img src="{{ asset('storage/images/' . $post->image1) }}" alt="" class="img-fluid mt-3">
                @endif
            </div>
            ...
            <div class="col-sm-12 col-md-3 form-group mt-2 p-2">
                ...
                @if ($post->image2)
                    <img src="{{ asset('storage/images/' . $post->image2) }}" alt="" class="img-fluid mt-3">
                @endif
            </div>
            ...
            <div class="col-sm-12 col-md-3 form-group mt-2 p-2">
                ...
                @if ($post->image3)
                    <img src="{{ asset('storage/images/' . $post->image3) }}" alt="" class="img-fluid mt-3">
                @endif
            </div>
            ...
            <div class="col-sm-12 col-md-3 form-group mt-2 p-2">
                ...
                @if ($post->image4)
                    <img src="{{ asset('storage/images/' . $post->image4) }}" alt="" class="img-fluid mt-3">
                @endif
            </div>
            ...
            <div class="col-sm-12 col-md-3 form-group mt-2 p-2 d-flex justify-content-center">
                ...
                @if ($post->image5)
                    <img src="{{ asset('storage/images/' . $post->image5) }}" alt="" class="img-fluid mt-3">
                @endif
            </div>
            ...
            <div class="col-sm-12 col-md-4">
                ...
                <select name="category" id="category" class="form-control px-3 py-2 rounded-1 mt-2">
                    <option value="{{ $post->category }}" disabled selected>{{ $post->category }}</option>
            ...
            <div class="col-sm-12 col-md-4">
                ...
                <select name="cuisine" id="cuisine" class="form-control px-3 py-2 rounded-1 mt-2">
                    <option value="{{ $post->cuisine }}" disabled selected>{{ $post->cuisine }}</option>
            ...
            <div class="col-sm-12 col-md-6 form-group mt-2 p-2">
                ...
                <textarea name="recipes" class="form-control mt-2" id="recipes" rows="4">{{ $post->recipes }}</textarea>
            ...
            <div class="mt-6">
                <button type="submit"
                    class="btn border-2 border-yellow-400 hover:bg-yellow-400 text-black rounded-lg">Update</button>
