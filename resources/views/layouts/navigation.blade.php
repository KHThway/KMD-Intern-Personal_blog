                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <div class="block h-9 w-auto fill-current text-gray-800">
                            Myy_<i class="bi bi-bootstrap-fill text-2xl"></i>
                        </div>
                    </a>
                </div>
                        ...
                        <button
                            ...
                            <div class="flex py-1">
                                ...
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRshXPk7aFNFHDBmUSNcWp9vA5_zl_KSVyxnGxFZiJEpQ&s"
                                    alt="" class="img-fluid border-transparent rounded-full me-2"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden bg-white">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                {{-- @if (count($avatar->avatar) == 0) --}}
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRshXPk7aFNFHDBmUSNcWp9vA5_zl_KSVyxnGxFZiJEpQ&s"
                    alt="" class="img-fluid rounded-full ms-1" style="width:40px; height:40px;">
                {{-- @else --}}
